    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($categoryList as $item) {
            ...
            $category
                ->setRef(uniqid('CAT_'))
                ->setName($item)
                ->setImage($faker->imageUrl(100, 100, 'gaming')); // Ajout des attributs à l'objet Category
        ...
        for ($i = 0; $i < 100; $i++) {
            ...
            $product
                ...
                ->setCategory($faker->randomElement($categoryArray)); // Ajout des attributs à l'objet Product
